...
<input  className="m-5 w-56 p-2 focus:outline-none  placeholder:italic placeholder:text-slate-400 text-center text-lg border-b-4 border-indigo-400 " type="text" placeholder=" search" value={searchRestro}
 onChange={(e)=>{
...
<button className="bg-indigo-500/30 text-violet-900/75 p-[7px] rounded-sm shadow-lg shadow-blue-400/60 hover:shadow-indigo-500/40 bg-gradient-to-r hover:from-blue-500/40  hover:to-indigo-500/40 w-3/4 m-3"  onClick={ratingClick}>Top-Rated Resturant</button> 
